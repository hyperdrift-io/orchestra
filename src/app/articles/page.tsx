...
export function generateMetadata(): Metadata {
  return { title: 'The AI-native organisation', description: 'Explore the Bridge, specialist skills, agent authority and integrations through working examples built by Hyperdrift.', alternates: { canonical: '/articles' }, openGraph: { title: 'The AI-native organisation', description: 'Working examples of the Bridge, skills, agent authority and integrations built by Hyperdrift.', url: 'https://ai.hyperdrift.io/articles', type: 'website' }, robots: isArticlePreview() ? { index: false, follow: false } : undefined };
}
