...
export const metadata: Metadata = {title:'How your organisation learns and grows',description:'Explore how connected business signals become useful decisions, scoped work and retained improvements. A living, interactive organisation by Hyperdrift.',alternates:{canonical:'/how-it-works'},openGraph:{title:'Every useful signal can become progress.',description:'Learn. Improve. Build on what works. Explore the AI-native organisation.',url:'https://ai.hyperdrift.io/how-it-works',images:[brandShareImage]}};
