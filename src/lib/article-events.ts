...
export const articleEventSchema = z.object({
  ...
  event: z.enum(['article_viewed', 'article_committed', 'article_engaged', 'article_shared', 'article_nudge_dismissed', 'article_cta_clicked', 'article_proof_opened', 'enquiry_started']),
