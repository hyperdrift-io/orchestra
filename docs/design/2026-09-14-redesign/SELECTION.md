...
| 14 Sep 2026 | 6 (repairs) | Submitted as the screens to build: 6C-c1 first screen, 6D-b four places, 6E-a proof, 6F-a enquiry, 6H-a mobile. Awaiting founder approval. |

Status: final screens submitted. ScreenCraft starts only on the founder's approval of this set. ScreenCraft stays out until the founder calls a round-5 (or later) image the screen to build.
