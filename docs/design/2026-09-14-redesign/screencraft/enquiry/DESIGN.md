...
Revision: 3. Source approval: Founder approved this screen as one of the five On-the-shoulder screens to build on 14 September 2026 (SELECTION.md, round 6). Map imported by hand: Codex vision capped until 19 Sep 2026..
...
- Observed: Proposal: not present in the approved image by design; placed in the open sky left of the giant's face.
- Observed: Overlay check: the first placement (30% wide) reached over the giant's nose; narrowed to 22%.
